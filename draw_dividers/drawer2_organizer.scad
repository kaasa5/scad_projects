...
module parts(part) {
    if (part == "connector_all") {
        ...
        translate([width_top/2,0.5*connector_length+width_top/2+border_overhang+185,0]){
            rotate([0,0,180]) 
            connector_zero(border=true);
        }
        translate([width_top/2,0.5*connector_length+width_top/2+border_overhang+185,0]){
        ...
        translate([border_overhang+(width_top/2)+(0.5*connector_length),back_dim,0]){
            rotate([0,0,90]) 
